...
export default function SignUpPage() {
        ...
        <div className="px-6 sm:px-10 py-8 sm:py-10">
          ...
          <Form className="w-full flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Button
                type="submit"
                className="w-full sm:flex-1 bg-linear-to-r from-orange-500 to-pink-500 text-white font-semibold transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-orange-500/25 active:scale-95"
              >
                <Check />
                Register
              </Button>
              ...
              <Button
                type="reset"
                variant="secondary"
                className="w-full sm:flex-1 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:bg-slate-100 active:scale-95"
              >
                Reset
              </Button>
            </div>
              ...
              {/* Divider */}
                        <div className="relative my-4 animate__animated animate__fadeIn">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-semibold 
  ...
  active:scale-95"
                        ...
                        {/* Login Link */}
                        <div className="mt-6 text-center animate__animated animate__fadeInUp animate__delay-2s">
